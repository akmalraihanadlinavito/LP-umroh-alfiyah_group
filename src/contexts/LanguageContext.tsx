...
const translations = {
  id: {
    ...
    'features.service.0.title': 'Antar-Jemput Bandara',
    'features.service.0.desc': 'Layanan transportasi dari/ke bandara dengan driver berpengalaman',
    'features.service.1.title': 'Mutawwif Berpengalaman',
    'features.service.1.desc': 'Bimbingan ibadah dari ahli yang berpengalaman puluhan tahun',
    'features.service.2.title': 'Tur Ziarah Eksklusif',
    'features.service.2.desc': 'Kunjungi tempat bersejarah dengan panduan lengkap',
    'features.service.3.title': 'Oleh-Oleh Praktis',
    'features.service.3.desc': 'Pesan souvenir berkualitas tanpa repot berbelanja',
    'features.service.4.title': 'Kuliner Halal',
    'features.service.4.desc': 'Makanan lezat dan terjamin halal dari chef terpercaya',
    'features.service.5.title': 'Perlengkapan Umrah',
    'features.service.5.desc': 'Sewa perlengkapan berkualitas dengan harga terjangkau',
    'features.service.6.title': 'SOS Button 24/7',
    'features.service.6.desc': 'Bantuan darurat kapan saja dengan respons cepat',
    'features.service.7.title': 'Bayar Fleksibel',
    'features.service.7.desc': 'Berbagai metode pembayaran yang aman dan mudah',
    ...
    'services.catalog.0.title': 'Transportation',
    'services.catalog.0.desc': 'Antar-jemput bandara dan transportasi dalam kota',
    'services.catalog.0.price': 'Mulai dari Rp 350.000',
    'services.catalog.1.title': 'Tour & Guidance',
    'services.catalog.1.desc': 'Mutawwif berpengalaman dan tur ziarah',
    'services.catalog.1.price': 'Mulai dari Rp 500.000',
    'services.catalog.2.title': 'Culinary & Souvenirs',
    'services.catalog.2.desc': 'Kuliner halal dan oleh-oleh khas Saudi',
    'services.catalog.2.price': 'Mulai dari Rp 200.000',
    'services.catalog.3.title': 'Equipment & Special Needs',
    'services.catalog.3.desc': 'Perlengkapan umrah dan kebutuhan khusus',
    'services.catalog.3.price': 'Mulai dari Rp 150.000',
    ...
    // App mockup
    'app.title': 'Amanah Umroh Mandiri',
    ...
    // Footer
    'footer.tagline': 'Umrah Mandiri, Tenang dengan Bantuan Kami',
    'footer.description': 'Layanan ground handling untuk jemaah umrah mandiri di Arab Saudi. Fleksibel, transparan, dan terpercaya.',
    ...
    'testimonial.1.quote': 'Harga transparan, no hidden cost. Saya bisa atur budget sesuai kebutuhan. Terima kasih Amanah Umroh Mandiri!',
  ...
  en: {
    ...
    'features.service.0.title': 'Airport Transfer',
    'features.service.0.desc': 'Transportation services from/to airport with experienced drivers',
    'features.service.1.title': 'Experienced Mutawwif',
    'features.service.1.desc': 'Worship guidance from experts with decades of experience',
    'features.service.2.title': 'Exclusive Pilgrimage Tour',
    'features.service.2.desc': 'Visit historical places with complete guidance',
    'features.service.3.title': 'Practical Souvenirs',
    'features.service.3.desc': 'Order quality souvenirs without the hassle of shopping',
    'features.service.4.title': 'Halal Culinary',
    'features.service.4.desc': 'Delicious and guaranteed halal food from trusted chefs',
    'features.service.5.title': 'Umrah Equipment',
    'features.service.5.desc': 'Rent quality equipment at affordable prices',
    'features.service.6.title': 'SOS Button 24/7',
    'features.service.6.desc': 'Emergency assistance anytime with quick response',
    'features.service.7.title': 'Flexible Payment',
    'features.service.7.desc': 'Various safe and easy payment methods',
    ...
    'services.catalog.0.title': 'Transportation',
    'services.catalog.0.desc': 'Airport pickup and city transportation',
    'services.catalog.0.price': 'Starting from $95',
    'services.catalog.1.title': 'Tour & Guidance',
    'services.catalog.1.desc': 'Experienced mutawwif and pilgrimage tours',
    'services.catalog.1.price': 'Starting from $135',
    'services.catalog.2.title': 'Culinary & Souvenirs',
    'services.catalog.2.desc': 'Halal cuisine and authentic Saudi souvenirs',
    'services.catalog.2.price': 'Starting from $55',
    'services.catalog.3.title': 'Equipment & Special Needs',
    'services.catalog.3.desc': 'Umrah equipment and special requirements',
    'services.catalog.3.price': 'Starting from $40',
    ...
    'blog.post.0.author': 'Amanah Team',
    ...
    // Footer
    'footer.tagline': 'Independent Umrah, Safe with Our Assistance',
    'footer.description': 'Ground handling services for independent umrah pilgrims in Saudi Arabia. Flexible, transparent, and trusted.',
    ...
    'testimonial.0.location': 'Jakarta',
    'testimonial.1.quote': 'Transparent pricing, no hidden costs. I can manage my budget according to my needs. Thank you Amanah Umroh Mandiri!',
